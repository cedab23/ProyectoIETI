...
public class SharedWallet {
  ...
  @ArraySchema(
      ...
      schema =
          @Schema(description = "User ID of a participant", example = "user-456", type = "string"))
  ...
  @ArraySchema(arraySchema = @Schema(description = "List of participant user IDs"))
  ...
  @ArraySchema(
      arraySchema =
          @Schema(description = "Wallet transactions", accessMode = Schema.AccessMode.READ_ONLY))
