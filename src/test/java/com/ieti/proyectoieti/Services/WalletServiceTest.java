...
class WalletServiceTest {
    ...
    void createWallet_EmptyName_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> walletService.createWallet(null, USER_ID));
    }

    @Test
    void createWallet_EmptyCreatorId_ThrowsException() {
        assertThrows(IllegalArgumentException.class,
                () -> walletService.createWallet(WALLET_NAME, ""));

        assertThrows(IllegalArgumentException.class,
                () -> walletService.createWallet(WALLET_NAME, null));
    }
    ...
    void addParticipant_WalletNotFound_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> walletService.addParticipant(WALLET_ID, "new-user"));
    }
    ...
    void addFunds_InvalidAmount_ThrowsException() {
        assertThrows(IllegalArgumentException.class,
                () -> walletService.addFunds(WALLET_ID, -50.0, USER_ID));

        assertThrows(IllegalArgumentException.class,
                () -> walletService.addFunds(WALLET_ID, 0.0, USER_ID));
